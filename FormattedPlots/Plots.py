...
def LargestSatelliteVsEnvironment(host,sats,rest,rad,path=''):
    ...
    ax[0][0].set_ylabel(r'Log(M$_{vir}$) of\nLargest Satellite [M$_{\odot}$]',fontsize=25)
    ...
    ax[1][0].set_xlabel(r'Distance to closest Large Halo (M$_{vir}$ $>$ 5*10$^{11}$) [R/R$_{vir}$]',fontsize=25)
    ax[1][0].set_ylabel(r'M$_{sat}$ / M$_{host}$ [M$_{\odot}$]',fontsize=25)
    ...
    ax[1][1].set_xlabel('N',fontsize=25)
