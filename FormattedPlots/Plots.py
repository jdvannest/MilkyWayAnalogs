...
def LargestSatelliteVsEnvironment(host,sats,rest,rad,path=''):
    ...
    ax[0][0].set_xticks
    ax[0][1].set_xticks([5,10,15,20,25,30])
    ax[1][1].set_xticks([5,10,15,20,25,30])
    ax[0][0].set_ylim([9.5,11.2])
    ax[0][1].set_ylim([9.5,11.2])
    ...
    ax[0][0].tick_params(labelsize=15,direction='in',length=5,labelbottom=False,right=True,labelright=False)
    ax[1][0].tick_params(labelsize=15,direction='in',length=5,top=True,right=True,labelright=False)
    ax[0][1].tick_params(labelsize=15,direction='in',length=5,labelbottom=False,labelleft=False)
    ax[1][1].tick_params(labelsize=15,direction='in',length=5,top=True,labelleft=False)
    ax[0][0].set_ylabel(r'Log(M$_{vir}$) of Largest Satellite [M$_{\odot}$]',fontsize=18)
    ax[0][0].scatter(x1,y1,c='k',label=r'All Satellites Smaller than M$_{vir}$')
    ax[0][0].scatter(x2,y2,c='r',label=r'Contains Satellite Larger than M$_{vir}$')
    ax[1][0].set_xlabel(r'Distance to closest Large Halo (M$_{vir}$ $>$ 5*10$^{11}$) [R/R$_{vir}$]',fontsize=20)
    ax[1][0].set_ylabel(r'M$_{sat}$ / M$_{host}$ [M$_{\odot}$]',fontsize=20)
    ...
    ax[0][0].legend(loc='upper right',prop={'size':13},frameon=True)
    ...
    ax[1][1].set_xlabel('N',fontsize=20)
