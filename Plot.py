...
def PLOT(S,MW,LH,rest,rad,over,output_path):
    ...
    SpecificFrequncyStellarMass(MW,rest,rad,over,output_path)
    SpecificFrequncyDistance(MW,rest,rad,over,output_path)
    SpecificFrequncyEnvironmentalDensity(MW,rest,rad,over,output_path)
    BinnedSpecificFrequncyStellarMass(MW,rest,rad,over,output_path)
    BinnedSpecificFrequncyDistance(MW,rest,rad,over,output_path)
    BinnedSpecificFrequncyEnvironmentalDensity(MW,rest,rad,over,output_path)
