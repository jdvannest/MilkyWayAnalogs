...
for i in [2,1,0]:
    rvir = pickle.load(open(f'../DataFiles/MilkyWay.{nums[i]}.sim.pickle','rb'))
    r300 = pickle.load(open(f'../DataFiles/MilkyWay.{nums[i]}.300.pickle','rb'))
    ...
    ax.text(10.8,-6+i,(f'{round(up/tot*100,2)}'+r'$\%\uparrow$'+f', {round(dn/tot*100,2)}'+r'$\%\downarrow$'),fontsize=15,c=c[i],horizontalalignment='right')
...
for i in [1,2,7]:
    rvir = pickle.load(open(f'../DataFiles/MilkyWay.{i}.sim.pickle','rb'))
    r300 = pickle.load(open(f'../DataFiles/MilkyWay.{i}.300.pickle','rb'))
    ...
    ax.text(10.8,.5,(f'{round(up/tot*100,2)}'+r'$\%\uparrow$'),fontsize=15,horizontalalignment='right')
    ax.text(10.8,0,f'{round(dn/tot*100,2)}'+r'$\%\downarrow$',fontsize=15,horizontalalignment='right')
    ax.legend(loc='upper left',prop={'size':15})
